### Setup required IAM role to deploy EKS cluster
...
### Setup required IAM role for EKS data plane
...
### Setup IAM role for Fargate profile

resource "aws_iam_role" "eks_fargate_role" {
  name = var.fargate_profile_role
